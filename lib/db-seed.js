  ...
  try {
    ...
    await query(
      ...
      [
        ...
        JSON.stringify([
          { id: "PLO-1", description: "Demonstrate deep understanding of computer science core foundations and theories." },
          { id: "PLO-2", description: "Apply software engineering principles to design, develop and test high-quality software solutions." }
        ]),
        JSON.stringify([
          ...
          { id: "CLO-2", description: "Write structured programs using arrays, user-defined functions, and parameter passing.", alignments: ["PLO-2"] }
        ]),
        JSON.stringify([
    ...
    const plans101 = [
      { week: 1, topic: "PUP Orientation & Introduction to Computing Concept", acts: "Interactive lecture, Ice-breaker discussion", ass: "Personal learning goal essay", mats: "PUP Handbook, Slide deck 1", dlo: "Orient students with PUP values and vision", clo: '["CLO-1"]' },
      { week: 2, topic: "Computer Hardware Components and Processing", acts: "Virtual assembly lab, group hardware comparison", ass: "Hardware component labeling quiz", mats: "Lab worksheet, Slide deck 2", dlo: "Explain hardware operation and logic processing", clo: '["CLO-1"]' },
      { week: 3, topic: "Operating Systems and System Software Utilities", acts: "Disk partition demo, command-line basics", ass: "Practical shell commands quiz", mats: "Operating systems manual, Slide deck 3", dlo: "Manipulate system configurations and command prompt tools", clo: '["CLO-2"]' },
      { week: 4, topic: "Networking Fundamentals, Internet, and Cloud Architecture", acts: "Ping/traceroute analysis, network diagramming", ass: "Network topology mapping assignment", mats: "Networking essentials guide", dlo: "Diagnose basic network connectivity issues", clo: '["CLO-2"]' }
    ];
